...
# ---------------------------------------------------------------------------------
# Política de offsets para el benchmark
# - base: 0 (0-based) o 1 (1-based)
# - end_inclusive: True si el benchmark espera 'end' inclusivo
# Puedes sobreescribir por ENV: EVAL_OFFSET_BASE / EVAL_END_INCLUSIVE
# ---------------------------------------------------------------------------------
EVAL_OFFSETS = {
    "base": int(os.getenv("EVAL_OFFSET_BASE", "0")),              # 0 o 1
    "end_inclusive": os.getenv("EVAL_END_INCLUSIVE", "true").lower() == "true",
}
