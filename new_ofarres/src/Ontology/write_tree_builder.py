"""
Helper script to write tree_builder.py correctly.
Run with: python write_tree_builder.py
"""
...
# Write the file
import os
output_path = os.path.join(os.path.dirname(__file__), 'tree_builder.py')
with open(output_path, 'w', encoding='utf-8') as f:
    f.write(code)

print("tree_builder.py written successfully!")
